            ...
            <>
                ...
                <div>
                    <p>
                        Total Price Summary: ${" "}
                        {
                            products.reduce((acu, product) => {
                                return acu + product.price
                            }, 0)
                        }
                    </p>
                </div>
                ...
                <ul>
                    {
                        products.filter((product) => {
                            ...
                            .map((product) => {
                                return (
                                    <li key={product.id}>
                                        <strong>{product.name}</strong> - {product.discountedPrice} - Discounted from: {product.price} Category: {" "} {product.category}
                                    </li>
                                )
                            })
                    }
...
const LogicalAnd = () => {
    ...
    let y = 10;
    if (x > 0 && y > 0) {
        return <p>both x and y is greater than 0</p>
    } else {
        <></>
    }
}
